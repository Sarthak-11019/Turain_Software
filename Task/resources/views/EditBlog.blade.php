...
@if(isset($Blogdata))    
    <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <table> @foreach($Blogdata as $data)
            <tr> <td><input type="hidden" readonly value="{{$data->id}}" name="BlogID">
                    <img src="{{$data->image}}" alt="Database Image" width="100px"></td></tr>
            <tr>  
                <td>Blog Image:</td>
                <td>
            ...
            <tr>
                <td>Blog Title:</td>
                <td>
                    <input type="text" name="title" id="title" value="{{$data->title}}" required onkeyup="title_valid()">
            ...
            <tr>
                ...
                <td>
                    <textarea name="desc" id="desc" placeholder="Enter Your Blog Details"  onkeyup="desc_valid()">{{$data->desc}}</textarea>
